...
def remove_oasis_params(params: dict) -> dict:
    """
    Removes OASIS specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with OASIS parameters removed.
    """
    oasis_params = {
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_oasis_params(params)
